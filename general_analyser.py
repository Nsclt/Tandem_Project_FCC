...
def main():
    ...
    plt.hlines(0.1365371 , -10,10, 'crimson', linestyle='solid', label='SM Value')
    plt.hlines(0.1225371 , -10,10, 'pink', linestyle='solid', label='lower limit on SM')
    plt.hlines(0.1505371 , -10,10, 'pink', linestyle='solid', label='lower limit on SM')
    plt.fill_between(t, 0.1225371,0.1505371 ,facecolor='pink')
    plt.grid()
    plt.xlim(-2.1,0.5)
    plt.ylim(0,0.4)
    plt.xlabel('ctW')
