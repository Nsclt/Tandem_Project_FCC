...
C     
     ...
     $ -1D0)*(V3(5)+CI*(V3(4)))-P3(3)*(V3(3)+V3(6)))))))
      TMP14 = (F1(3)*(F2(3)*(P3(0)*(V3(3)-V3(6))+(P3(1)*(+CI*(V3(5))
     ...
     $ +CI*(V3(4))-V3(5))-P3(3)*(V3(3)+V3(6)))))))
      TMP16 = (F1(5)*(F2(5)*(P3(0)*(V3(3)+V3(6))+(P3(1)*(+CI*(V3(5))
     $ -V3(4))+(P3(2)*(-1D0)*(V3(5)+CI*(V3(4)))-P3(3)*(V3(3)+V3(6)))))
     ...
     $ -1D0)*(V3(5)+CI*(V3(4)))+P3(3)*(V3(3)-V3(6)))))))
      VERTEX = COUP*(-CI*(TMP14+TMP15)+CI*(TMP13+TMP16))
      END
...
C      P(-1,3)*Gamma(-1,-3,-2)*Gamma(3,2,-3)*ProjP(-2,1)
C     
      SUBROUTINE FFV10_12_0(F1, F2, V3, COUP1, COUP2,VERTEX)
      IMPLICIT NONE
      COMPLEX*16 CI
      PARAMETER (CI=(0D0,1D0))
      COMPLEX*16 V3(*)
      ...
      CALL FFV12_0(F1,F2,V3,COUP2,TMP)
      VERTEX = VERTEX + TMP
      END
