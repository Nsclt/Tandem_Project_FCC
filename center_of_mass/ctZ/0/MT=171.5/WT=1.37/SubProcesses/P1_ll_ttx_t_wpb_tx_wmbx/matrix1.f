...
C     
C     Generated by MadGraph5_aMC@NLO v. 2.7.0, 2020-01-20
...
C     
C     Process: e+ e- > t t~ QED<=2 @1
C     *   Decay: t > w+ b WEIGHTED<=1
C     *   Decay: t~ > w- b~ WEIGHTED<=1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
...
C     
      ...
      DATA (NHEL(I,  15),I=1,6) /-1, 1, 0,-1, 0, 1/
      ...
      DATA (NHEL(I,  21),I=1,6) /-1, 1, 0, 1, 0, 1/
      DATA (NHEL(I,  22),I=1,6) /-1, 1, 0, 1, 0,-1/
      ...
      DATA (NHEL(I,  52),I=1,6) /-1,-1, 0,-1, 0,-1/
      DATA (NHEL(I,  53),I=1,6) /-1,-1, 0,-1,-1, 1/
      DATA (NHEL(I,  54),I=1,6) /-1,-1, 0,-1,-1,-1/
      DATA (NHEL(I,  55),I=1,6) /-1,-1, 0, 1, 1, 1/
      DATA (NHEL(I,  56),I=1,6) /-1,-1, 0, 1, 1,-1/
      DATA (NHEL(I,  57),I=1,6) /-1,-1, 0, 1, 0, 1/
      DATA (NHEL(I,  58),I=1,6) /-1,-1, 0, 1, 0,-1/
      ...
      DATA (NHEL(I,  87),I=1,6) / 1, 1, 0,-1, 0, 1/
      DATA (NHEL(I,  88),I=1,6) / 1, 1, 0,-1, 0,-1/
      DATA (NHEL(I,  89),I=1,6) / 1, 1, 0,-1,-1, 1/
      DATA (NHEL(I,  90),I=1,6) / 1, 1, 0,-1,-1,-1/
      DATA (NHEL(I,  91),I=1,6) / 1, 1, 0, 1, 1, 1/
      DATA (NHEL(I,  92),I=1,6) / 1, 1, 0, 1, 1,-1/
      DATA (NHEL(I,  93),I=1,6) / 1, 1, 0, 1, 0, 1/
      DATA (NHEL(I,  94),I=1,6) / 1, 1, 0, 1, 0,-1/
      ...
      DATA (NHEL(I,  99),I=1,6) / 1, 1, 1,-1, 0, 1/
      ...
      DATA (NHEL(I, 111),I=1,6) / 1,-1,-1,-1, 0, 1/
      ...
      DATA (NHEL(I, 117),I=1,6) / 1,-1,-1, 1, 0, 1/
      DATA (NHEL(I, 118),I=1,6) / 1,-1,-1, 1, 0,-1/
      ...
      DATA (NHEL(I, 123),I=1,6) / 1,-1, 0,-1, 0, 1/
      DATA (NHEL(I, 124),I=1,6) / 1,-1, 0,-1, 0,-1/
      DATA (NHEL(I, 125),I=1,6) / 1,-1, 0,-1,-1, 1/
      DATA (NHEL(I, 126),I=1,6) / 1,-1, 0,-1,-1,-1/
      DATA (NHEL(I, 127),I=1,6) / 1,-1, 0, 1, 1, 1/
      DATA (NHEL(I, 128),I=1,6) / 1,-1, 0, 1, 1,-1/
      DATA (NHEL(I, 129),I=1,6) / 1,-1, 0, 1, 0, 1/
      ...
      DATA (NHEL(I, 135),I=1,6) / 1,-1, 1,-1, 0, 1/
      DATA (NHEL(I, 136),I=1,6) / 1,-1, 1,-1, 0,-1/
      ...
      DATA (NHEL(I, 142),I=1,6) / 1,-1, 1, 1, 0,-1/
...
C     ----------
     ...
     $   , ZERO)
      ...
      CALL FFV11_3_1(W(1,4),W(1,3),GC_644,GC_619,MDL_MT, FK_MDL_WT,W(1
     $ ,5))
      CALL VXXXXX(P(0,5),MDL_MW,NHEL(5),+1*IC(5),W(1,4))
      CALL IXXXXX(P(0,6),MDL_MB,NHEL(6),-1*IC(6),W(1,3))
      CALL FFV11_3_2(W(1,3),W(1,4),GC_618,GC_645,MDL_MT, FK_MDL_WT,W(1
     $ ,6))
C     Amplitude(s) for diagram number 1
      CALL FFFF12_15_2_21_22_23_7_8_24_110_0(W(1,2),W(1,1),W(1,6),W(1
     $ ,5),GC_315,GC_516,GC_321,GC_543,GC_536,GC_317,GC_522,GC_319
     $ ,GC_316,GC_318,AMP(1))
      CALL FFV1P0_3(W(1,2),W(1,1),GC_3,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL FFV10_12_0(W(1,6),W(1,5),W(1,3),GC_699,GC_698,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL FFV7_0(W(1,6),W(1,5),W(1,3),GC_2,AMP(3))
      CALL FFV2_8_3(W(1,2),W(1,1),GC_574,GC_581,MDL_MZ, FK_MDL_WZ,W(1
     $ ,3))
C     Amplitude(s) for diagram number 4
      CALL FFV10_12_0(W(1,6),W(1,5),W(1,3),GC_600,GC_599,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV5_0(W(1,6),W(1,5),W(1,3),GC_825,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_9_0(W(1,6),W(1,5),W(1,3),GC_575,GC_580,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV2_0(W(1,6),W(1,5),W(1,3),GC_815,AMP(7))
