...
C     
C     Process: e+ e- > t t~ FCNC=0 dim6<=1 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 5
      CALL FFV5_0(W(1,4),W(1,3),W(1,5),GC_825,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_9_0(W(1,4),W(1,3),W(1,5),GC_575,GC_580,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV2_0(W(1,4),W(1,3),W(1,5),GC_815,AMP(7))
