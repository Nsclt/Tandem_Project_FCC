...
C     
C     Process: e+ e- > t t~ > w- b~ w+ b WEIGHTED<=8 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   , ZERO)
      ...
      CALL FFV1P0_3(W(1,2),W(1,1),GC_3,DCMPLX(ZERO),W(1,7))
      CALL FFV2_2(W(1,4),W(1,3),GC_100,DCMPLX(CMASS_MDL_MT),W(1,8))
      CALL FFV2_1(W(1,6),W(1,5),GC_100,DCMPLX(CMASS_MDL_MT),W(1,4))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,8),W(1,4),W(1,7),GC_2,AMP(1))
      CALL FFV2_4_3(W(1,2),W(1,1),-GC_51,GC_59,DCMPLX(CMASS_MDL_MZ)
     $ ,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL FFV2_5_0(W(1,8),W(1,4),W(1,7),GC_51,GC_58,AMP(2))
