...
C     ----------
     ...
     $   , ZERO)
      ...
      CALL FFV2_1(W(1,4),W(1,3),GC_100,MDL_MT, FK_MDL_WT,W(1,5))
      CALL VXXXXX(P(0,5),MDL_MW,NHEL(5),+1*IC(5),W(1,4))
      CALL IXXXXX(P(0,6),MDL_MB,NHEL(6),-1*IC(6),W(1,3))
      CALL FFV2_2(W(1,3),W(1,4),GC_100,MDL_MT, FK_MDL_WT,W(1,6))
      CALL FFV1P0_3(W(1,2),W(1,1),GC_3,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,6),W(1,5),W(1,3),GC_2,AMP(1))
      CALL FFV2_4_3(W(1,2),W(1,1),-GC_51,GC_59,MDL_MZ, FK_MDL_WZ,W(1,3)
     $ )
C     Amplitude(s) for diagram number 2
      CALL FFV2_5_0(W(1,6),W(1,5),W(1,3),GC_51,GC_58,AMP(2))
